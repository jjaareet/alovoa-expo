...
export const API_RESOURCE_USER_ONBOARDING =
  DOMAIN + '/api/v1/resource/user/onboarding';
export const API_RESOURCE_USER_BLOCKED =
  DOMAIN + '/api/v1/resource/blocked-users';
export const API_RESOURCE_USER_LIKED = DOMAIN + '/api/v1/resource/liked-users';
export const API_RESOURCE_USER_HIDDEN =
  DOMAIN + '/api/v1/resource/disliked-users';
...
export const USER_INTEREST_AUTOCOMPLETE =
  DOMAIN + '/user/interest/autocomplete/%s';
...
export const USER_UPDATE_PROFILE_PICTURE =
  DOMAIN + '/user/update/profile-picture';
...
export const USER_UPDATE_PREFERED_GENDER =
  DOMAIN + '/user/update/preferedGender/%s/%s';
...
export const USER_SETTING_EMAIL_LIKE =
  DOMAIN + '/user/settings/emailLike/update/%s';
export const USER_SETTING_EMAIL_CHAT =
  DOMAIN + '/user/settings/emailChat/update/%s';

export const USER_UPDATE_LOCATION = DOMAIN + '/user/update/location/%s/%s';

export const USER_UPDATE_VERIFICATION_PICTURE =
  DOMAIN + '/user/update/verification-picture';
export const USER_UPDATE_VERIFICATION_PICTURE_UPVOTE =
  DOMAIN + '/user/update/verification-picture/upvote/%s';
export const USER_UPDATE_VERIFICATION_PICTURE_DOWNVOTE =
  DOMAIN + '/user/update/verification-picture/downvote/%s';
